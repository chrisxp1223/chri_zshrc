# Generated by Powerlevel10k configuration wizard on 2025-03-07 at 17:57 CST.
...
#    per_directory_history   # Oh My Zsh per-directory-history local/global indicator
  ...
  function prompt_my_cpu_temp() {
      ...
      # ✅ 使用 `p10k segment` 讓 Powerlevel10k 顯示 CPU 溫度
      p10k segment -b 1 -f 3 -i '🌡' -t "CPU: ${temp}"
  }
  ...
  typeset -g POWERLEVEL9K_MY_CPU_TEMP_FOREGROUND=2
